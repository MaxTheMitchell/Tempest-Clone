...
grow : Float -> Position -> ConnectedPolygon -> ConnectedPolygon
grow percent orgin cPoly =
  ConnectedPolygon
    cPoly.segments
    (Poly.grow percent orgin cPoly.innerPoly)
    (Poly.grow percent orgin cPoly.outerPoly)
